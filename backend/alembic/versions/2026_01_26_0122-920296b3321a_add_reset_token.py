...
Revision ID: 920296b3321a
Revises: 8023060b27a5
Create Date: 2026-01-26 01:22:35.088255
...
revision: str = '920296b3321a'
down_revision: Union[str, None] = '8023060b27a5'
...
def upgrade() -> None:
    ...
    print("✅ Added password reset columns to users table")
...
def downgrade() -> None:
    ...
    op.drop_column('users', 'reset_token_expiry')
    op.drop_column('users', 'reset_token_hash')
    op.alter_column('mail_queue', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               server_default=sa.text('now()'),
               existing_nullable=False)
    op.alter_column('mail_queue', 'status',
               existing_type=sa.String(),
               type_=postgresql.ENUM('PENDING', 'SENT', 'FAILED', name='mailstatus'),
               existing_nullable=False)
    op.alter_column('mail_queue', 'content',
               existing_type=sa.String(),
               type_=sa.TEXT(),
               existing_nullable=False)
    op.alter_column('mail_queue', 'id',
               existing_type=sa.UUID(),
               server_default=sa.text('uuid_generate_v4()'),
               existing_nullable=False)
    op.add_column('locations', sa.Column('metadata', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False))
    op.drop_index(op.f('ix_locations_geom'), table_name='locations')
    ...
    op.alter_column('locations', 'id',
               ...
               server_default=sa.text('uuid_generate_v4()'),
               existing_nullable=False)
    op.drop_column('locations', 'extra_data')
    op.create_unique_constraint('uq_inventory_user_artifact', 'inventory', ['user_id', 'artifact_id'])
    op.alter_column('inventory', 'saved_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               server_default=sa.text('now()'),
               existing_nullable=False)
    op.alter_column('inventory', 'id',
               ...
               server_default=sa.text('uuid_generate_v4()'),
               existing_nullable=False)
    op.create_foreign_key('fk_explored_chunks_user_id_users', 'explored_chunks', 'users', ['user_id'], ['id'], ondelete='CASCADE')
    op.create_unique_constraint('uq_explored_chunks_user_chunk', 'explored_chunks', ['user_id', 'chunk_x', 'chunk_y'])
    op.alter_column('explored_chunks', 'explored_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               server_default=sa.text('now()'),
               existing_nullable=False)
    op.alter_column('explored_chunks', 'id',
               existing_type=sa.UUID(),
               server_default=sa.text('uuid_generate_v4()'),
               existing_nullable=False)
    op.create_unique_constraint('uq_connections_users', 'connections', ['user_a_id', 'user_b_id'])
    ...
    op.alter_column('artifacts', 'id',
               ...
               server_default=sa.text('uuid_generate_v4()'),
               existing_nullable=False)
    op.alter_column('artifact_replies', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               server_default=sa.text('now()'),
               existing_nullable=False)
    op.alter_column('artifact_replies', 'id',
               existing_type=sa.UUID(),
               server_default=sa.text('uuid_generate_v4()'),
               existing_nullable=False)
    ...
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".state_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    ...
    op.create_index('idx_tiger_state_the_geom_gist', 'state', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist')
    ...
    op.create_index('street_type_lookup_abbrev_idx', 'street_type_lookup', ['abbrev'], unique=False, schema='tiger')
    op.create_table('pagc_lex',
    sa.Column('id', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".pagc_lex_id_seq\'::regclass)'), autoincrement=True, nullable=False),
    ...
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".tabblock_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('countyfp', sa.VARCHAR(length=3), autoincrement=False, nullable=True),
    sa.Column('tractce', sa.VARCHAR(length=6), autoincrement=False, nullable=True),
    sa.Column('blockce', sa.VARCHAR(length=4), autoincrement=False, nullable=True),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".pagc_gaz_id_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('seq', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('word', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('stdword', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('token', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    op.create_table('place',
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".place_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('placefp', sa.VARCHAR(length=5), autoincrement=False, nullable=True),
    sa.Column('placens', sa.VARCHAR(length=8), autoincrement=False, nullable=True),
    sa.Column('plcidfp', sa.VARCHAR(length=7), autoincrement=False, nullable=False),
    ...
    op.create_index('tiger_place_the_geom_gist', 'place', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist')
    op.create_table('faces',
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".faces_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    ...
    op.create_index('tiger_faces_the_geom_gist', 'faces', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist')
    op.create_index('idx_tiger_faces_tfid', 'faces', ['tfid'], unique=False, schema='tiger')
    op.create_index('idx_tiger_faces_countyfp', 'faces', ['countyfp'], unique=False, schema='tiger')
    op.create_table('zip_lookup_base',
    sa.Column('zip', sa.VARCHAR(length=5), autoincrement=False, nullable=False),
    sa.Column('state', sa.VARCHAR(length=40), autoincrement=False, nullable=True),
    sa.Column('county', sa.VARCHAR(length=90), autoincrement=False, nullable=True),
    ...
    op.create_table('zcta5',
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".zcta5_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=False),
    sa.Column('zcta5ce', sa.VARCHAR(length=5), autoincrement=False, nullable=False),
    sa.Column('classfp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('mtfcc', sa.VARCHAR(length=5), autoincrement=False, nullable=True),
    ...
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".county_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('countyfp', sa.VARCHAR(length=3), autoincrement=False, nullable=True),
    ...
    op.create_index('idx_tiger_county', 'county', ['countyfp'], unique=False, schema='tiger')
    op.create_table('pagc_rules',
    sa.Column('id', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".pagc_rules_id_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('rule', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('is_custom', sa.BOOLEAN(), server_default=sa.text('true'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='pagc_rules_pkey'),
    schema='tiger'
    ...
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".cousub_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('countyfp', sa.VARCHAR(length=3), autoincrement=False, nullable=True),
    sa.Column('cousubfp', sa.VARCHAR(length=5), autoincrement=False, nullable=True),
    ...
    op.create_index('tige_cousub_the_geom_gist', 'cousub', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist')
    op.create_table('tract',
    sa.Column('gid', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('countyfp', sa.VARCHAR(length=3), autoincrement=False, nullable=True),
    ...
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".addrfeat_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('tlid', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=False),
    ...
    op.create_index('idx_addrfeat_zipr', 'addrfeat', ['zipr'], unique=False, schema='tiger')
    op.create_index('idx_addrfeat_zipl', 'addrfeat', ['zipl'], unique=False, schema='tiger')
    op.create_index('idx_addrfeat_tlid', 'addrfeat', ['tlid'], unique=False, schema='tiger')
    op.create_index('idx_addrfeat_geom_gist', 'addrfeat', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist')
    op.create_table('state',
    sa.Column('gid', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('region', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('division', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    ...
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".featnames_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('tlid', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('fullname', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    ...
    op.create_index('idx_tiger_featnames_tlid_statefp', 'featnames', ['tlid', 'statefp'], unique=False, schema='tiger')
    op.create_index('idx_tiger_featnames_snd_name', 'featnames', [sa.text('soundex(name::text)')], unique=False, schema='tiger')
    op.create_index('idx_tiger_featnames_lname', 'featnames', [sa.text('lower(name::text)')], unique=False, schema='tiger')
    ...
    op.create_index('place_lookup_state_idx', 'place_lookup', ['state'], unique=False, schema='tiger')
    op.create_index('place_lookup_name_idx', 'place_lookup', [sa.text('soundex(name::text)')], unique=False, schema='tiger')
    op.create_table('faces',
    sa.Column('gid', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('tfid', sa.NUMERIC(precision=10, scale=0), autoincrement=False, nullable=True),
    sa.Column('statefp00', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    ...
    op.create_index('secondary_unit_lookup_abbrev_idx', 'secondary_unit_lookup', ['abbrev'], unique=False, schema='tiger')
    op.create_table('county',
    sa.Column('gid', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('countyfp', sa.VARCHAR(length=3), autoincrement=False, nullable=True),
    ...
    op.create_index('countysub_lookup_state_idx', 'countysub_lookup', ['state'], unique=False, schema='tiger')
    op.create_index('countysub_lookup_name_idx', 'countysub_lookup', [sa.text('soundex(name::text)')], unique=False, schema='tiger')
    ...
    op.create_index('direction_lookup_abbrev_idx', 'direction_lookup', ['abbrev'], unique=False, schema='tiger')
    op.create_table('loader_platform',
    sa.Column('os', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('declare_sect', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('pgbin', sa.TEXT(), autoincrement=False, nullable=True),
    ...
    sa.Column('reason', postgresql.ENUM('SPAM', 'INAPPROPRIATE', 'HARASSMENT', 'MISINFORMATION', 'OTHER', name='reportreason'), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('status', postgresql.ENUM('PENDING', 'REVIEWED', 'RESOLVED', name='reportstatus'), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['artifact_id'], ['artifacts.id'], name='fk_reports_artifact_id_artifacts', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['reporter_id'], ['users.id'], name='fk_reports_reporter_id_users', ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id', name='pk_reports')
    )
    op.create_index('ix_reports_artifact_id', 'reports', ['artifact_id'], unique=False)
    op.create_table('edges',
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".edges_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('countyfp', sa.VARCHAR(length=3), autoincrement=False, nullable=True),
    sa.Column('tlid', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('tfidl', sa.NUMERIC(precision=10, scale=0), autoincrement=False, nullable=True),
    ...
    op.create_index('idx_tiger_edges_the_geom_gist', 'edges', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist')
    op.create_index('idx_tiger_edges_countyfp', 'edges', ['countyfp'], unique=False, schema='tiger')
    op.create_index('idx_edges_tlid', 'edges', ['tlid'], unique=False, schema='tiger')
    op.create_table('secondary_unit_lookup',
    sa.Column('name', sa.VARCHAR(length=20), autoincrement=False, nullable=False),
    sa.Column('abbrev', sa.VARCHAR(length=5), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('name', name='secondary_unit_lookup_pkey')
    ...
    op.create_table('bg',
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".bg_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    sa.Column('countyfp', sa.VARCHAR(length=3), autoincrement=False, nullable=True),
    sa.Column('tractce', sa.VARCHAR(length=6), autoincrement=False, nullable=True),
    sa.Column('blkgrpce', sa.VARCHAR(length=1), autoincrement=False, nullable=True),
    ...
    op.create_table('addr',
    sa.Column('gid', sa.INTEGER(), server_default=sa.text('nextval(\'"tiger".addr_gid_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('tlid', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('fromhn', sa.VARCHAR(length=12), autoincrement=False, nullable=True),
    sa.Column('tohn', sa.VARCHAR(length=12), autoincrement=False, nullable=True),
    sa.Column('side', sa.VARCHAR(length=1), autoincrement=False, nullable=True),
    ...
    op.create_index('idx_tiger_addr_zip', 'addr', ['zip'], unique=False, schema='tiger')
    op.create_index('idx_tiger_addr_tlid_statefp', 'addr', ['tlid', 'statefp'], unique=False, schema='tiger')
    op.create_table('zip_state_loc',
    sa.Column('zip', sa.VARCHAR(length=5), autoincrement=False, nullable=False),
    sa.Column('stusps', sa.VARCHAR(length=2), autoincrement=False, nullable=False),
    sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    ...
    op.create_index('county_lookup_state_idx', 'county_lookup', ['state'], unique=False, schema='tiger')
    op.create_index('county_lookup_name_idx', 'county_lookup', [sa.text('soundex(name::text)')], unique=False, schema='tiger')
